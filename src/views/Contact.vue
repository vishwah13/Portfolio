<template>
  <div>
    ...
    <div style="margin-bottom:40px;">I'm looking for a job !<br/>Feel free to contact me about any opportunity, or just to chat about the things I made.</div>

    <ul>
      <li>
        <i class="fa fa-user-circle-o fa-lg fa-fw"></i>
        <a href="http://vishwah.com" target="_blank">https://vishwah.com</a>
      </li>
      <li>
