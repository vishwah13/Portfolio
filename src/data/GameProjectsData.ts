...
export default [
    ...
    `, "#23bd69", true),
    new ProjectData("project-2", "T-Wrecks", "img/projects/T-wrecks.gif", `
    <div class="paragraph">
    <strong>T-wrecks</strong> is a 2D Action Platformer game, where the player needs to use the ball to defend him self form enemies, made for Score Space Jam #14, made using <strong>Unity and C#</strong>  .
    </div>
    <div class="paragraph center">
    ...
    <div class="paragraph center">
        <img class="pc-screenshot" src="img/projects/T-wrecks.png" alt="StuBrew VR Screenshot" />
    ...
    `, "#5a78af"),
    new ProjectData("project-6", "Vulkan graphics engine", "img/projects/Vulkan_teapot.gif", `
    <div class="paragraph">
    ...
    new ProjectData("project-7", "In Your Nightmare", "img/projects/IYM.png", `
    <div class="paragraph">
    ...
    new ProjectData("project-10", "Ultimate BreakOut", "img/projects/BreakOut.gif", `
    <div class="paragraph">
    ...
    <div class="paragraph center">
        ...
        <img class="pc-screenshot" src="img/projects/BreakOut2.jpg" alt="BreakOut Screenshot" />
                    ...
                    new ProjectData("project-11", "UE4 Platformer", "img/projects/Platformer_2.png", `
                    <div class="paragraph">
